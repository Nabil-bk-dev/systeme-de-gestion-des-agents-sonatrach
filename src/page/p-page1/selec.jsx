    ...
    <div className="w-full font-medium ">
      ...
      >
        {selected ? (
          ...
          <span>Selection Préparer visite </span>
        )}
      </div>
      <ul
        className={` bg-gray-50 mt-3 flex flex-col gap-3 overflow-y-auto ${
          open ? "max-h-40" : "max-h-0"
        }`}
      >
        <div className="flex items-center px-3 sticky top-0  bg-gray-50e">
          <input
            type="text"
            value={inputValue}
          ...
          .map((rv) => (
            ...
            >
              ...
              <div >
                ...
                <div className="text-left text-[13px] ml-2 flex">Type Rdv :<p className="ml-2 bg-gray-600 p-[2px] pl-[4px] pr-[4px] rounded-md text-[#ffffff] mr-2"> {rv.TypeRdv} </p> Taille Pt Poids   <p className="ml-2 bg-gray-600 p-[2px] pl-[4px] pr-[4px] rounded-md text-[#ffffff]"> {rv.Taille} {rv.Pt} {rv.Poids} </p></div>
              </div>
            </li>
          ))}
      </ul>
