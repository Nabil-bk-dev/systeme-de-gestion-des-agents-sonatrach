...
import Poste1 from "./page/p-page1/poste1.jsx";
import Poste3 from "./page/chef_service/poste3.jsx";
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/poste=1/:token"
          element={<Poste1 USER={USER} setUSER={setUSER} />}
        />

        <Route
          path="/poste=2/:token"
          element={<Poste2 USER={USER} setUSER={setUSER} />}
        />
        <Route
          path="/poste=3/:token"
          element={<Poste3 USER={USER} setUSER={setUSER} />}
        />
